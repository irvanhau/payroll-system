...
class TrialBalanceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.report.trial_balance', compact('date', 'category', 'dataCategory', 'dataAccount', 'dataReport', 'dataBegin'));
    }
    ...
    public function generatePdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('admin.download.trial_balance', $data);

        return response()->streamDownload(function () use ($pdf) {
            echo $pdf->stream();
        }, 'trial-balance-' . $categoryName . '-'  . $this->monthName[$month - 1] . $year . '.pdf');
    }
    ...
    public function generateExcel(Request $request)
    {
        ...
        return Excel::download(new TrialBalanceExport($category_id, $month, $year), 'trial-balance-' . $categoryName . '-' . $this->monthName[$month - 1] . $year . ".xlsx");
    }
}

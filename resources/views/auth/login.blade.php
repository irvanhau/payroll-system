...
<body>
    <section class="vh-100">
            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form method="POST" action="{{ route('login') }}">
                        @csrf
                        <div
                            class="flex-row d-flex align-items-center justify-content-center justify-content-lg-center">
                            <h1 class="">Payroll System PT. Ultra Media</h1>
                        </div>
        ...
        <div
            class="px-4 py-4 text-center d-flex flex-column flex-md-row text-md-start justify-content-between px-xl-5 bg-primary">
            <!-- Copyright -->
            <div class="mb-3 text-white mb-md-0">

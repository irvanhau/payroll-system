    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    {{-- FILTER BY MONTH --}}
                    <form method="GET" action="{{ route('profit-loss.index') }}" class="mb-4">
                        <div class="row">
                            <div class="col-2">
                    ...
                    <a class="mb-3 btn btn-info" href={{ route('profit-loss.pdf', ['date' => $date]) }}><i
                            class="fas fa-file-pdf"></i> Export
                        PDF</a>
                    <a class="mb-3 btn btn-success" href="{{ route('profit-loss.excel', ['date' => $date]) }}"><i
                                                ...
                                                <tr>
                                                    ...
                                                    @foreach ($sumBeginRevenues as $sumBeginRevenue)
                                                        @if ($sumBeginRevenue->account_no == $levelTwoRevenue->account_no)
                                                            @php
                                                                $totalBeginLevelTwoRevenue =
                                                                    $sumBeginRevenue->credit - $sumBeginRevenue->debit;
                                                    ...
                                                    @foreach ($sumMoveRevenues as $sumMoveRevenue)
                                                        @if ($sumMoveRevenue->account_no == $levelTwoRevenue->account_no)
                                                            @php
                                                                $totalMoveLevelTwoRevenue =
                                                                    $sumMoveRevenue->credit - $sumMoveRevenue->debit;
                                                ...
                                                <tr>
                                                    ...
                                                    @foreach ($sumBeginCoses as $sumBeginCos)
                                                        @if ($sumBeginCos->account_no == $levelTwoCos->account_no)
                                                            @php
                                                                $totalBeginLevelTwoCos =
                                                                    $sumBeginCos->debit - $sumBeginCos->credit;
                                                    ...
                                                    @foreach ($sumMoveCoses as $sumMoveCos)
                                                        @if ($sumMoveCos->account_no == $levelTwoCos->account_no)
                                                            @php
                                                                $totalMoveLevelTwoCos =
                                                                    $sumMoveCos->debit - $sumMoveCos->credit;
                                                        ...
                                                        @if ($sumBeginOtherRevenue->account_no == $levelTwoOtherRevenue->account_no)
                                                            @php
                                                                $totalBeginLevelTwoOtherRevenue =
                                                                    $sumBeginOtherRevenue->credit -
                                                                    $sumBeginOtherRevenue->debit;
                                                        ...
                                                        @if ($sumMoveOtherRevenue->account_no == $levelTwoOtherRevenue->account_no)
                                                            @php
                                                                $totalMoveLevelTwoOtherRevenue =
                                                                    $sumMoveOtherRevenue->credit -
                                                                    $sumMoveOtherRevenue->debit;
                                                ...
                                                <tr>
                                                    ...
                                                    @foreach ($sumBeginExpenses as $sumBeginExpense)
                                                        @if ($sumBeginExpense->account_no == $levelTwoExpense->account_no)
                                                            @php
                                                                $totalBeginLevelTwoExpense =
                                                                    $sumBeginExpense->debit - $sumBeginExpense->credit;
                                                    ...
                                                    @foreach ($sumMoveExpenses as $sumMoveExpense)
                                                        @if ($sumMoveExpense->account_no == $levelTwoExpense->account_no)
                                                            @php
                                                                $totalMoveLevelTwoExpense =
                                                                    $sumMoveExpense->debit - $sumMoveExpense->credit;

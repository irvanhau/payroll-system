...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="javascript:void(0)" id="updateFormAllowance">
                        @method('PUT')
                        @csrf
                        ...
                        <a href="{{ route('allowance.index') }}" class="my-3 btn btn-danger">Back</a>
    ...
    @push('addon-script')
        <script>
            $("#updateFormAllowance").submit(function(e) {
                e.preventDefault();
